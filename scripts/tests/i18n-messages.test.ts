...
const REPORT_KEYS = [
  ...
  "wallAdAlmost",
  "wallAdNot",
  // analyzer-report-redesign brief §1 — the v2 report copy (hero + stepper +
  // dashboard), locked in both locales like the rest of the report namespace.
  ...
  "v2CatCroPrinciples",
  "v2CatNicheCoherence",
  "v2CatTechnicalOptimization",
  "v2CatLayoutProportion",
  "v2CatImageQuality",
  "v2CatColorIntegration",
  "v2NavLabel",
  "v2StepFixes",
  "v2StepWinners",
  "v2StepAudit",
