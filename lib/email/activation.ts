    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;border:1px solid #ececec;">
        <tr><td style="padding:28px 28px 6px;">
          <div style="font-size:12px;letter-spacing:2px;text-transform:uppercase;color:#0D9488;font-weight:600;">EliteVault</div>
        ...
        <tr><td style="padding:18px 28px 28px;">
          <a href="${appUrl}/app/analyzer" style="display:inline-block;background:#2DD4BF;color:#0A0A0F;text-decoration:none;font-weight:600;font-size:14px;padding:11px 18px;border-radius:9px;">${cta}</a>
