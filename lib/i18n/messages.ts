...
const en: Dict = {
  ...
  footer: {
    ...
    convertmate: "ConvertMate alternative",
    blog: "Blog",
    about: "About",
    support: "Support",
    api: "API",
  ...
  metaPromo: {
    ...
    teaserTitle: "See your Meta campaign before you spend a dollar",
    teaserBody:
      "Three honest 7-day scenarios — conservative, balanced, aggressive — projected from your store and your numbers.",
    sampleLabel: "Example — not your numbers",
    roasLabel: "7-day ROAS",
    conservative: "Conservative",
    balanced: "Balanced",
    aggressive: "Aggressive",
    unlockPro: "Unlock with Pro — ${price}/mo",
    signupCta: "Create your free account",
    runCta: "Run your simulation",
    optimizerUpsell: "The Meta Ads Optimizer is on Scale.",
    optimizerCta: "Upgrade to Scale",
    railTitle: "Your Meta campaign, projected",
    mobileLocked: "Preview your Meta campaign",
    mobileRun: "Your Meta simulator",
    cancelAnytime: "Cancel anytime · prorated",
  },
  pricing: {
  ...
  compare: {
    ...
    closingBold: "audits your store and shows you the winners to copy",
    closingPost: "— for the price of a lunch.",
    cta: "Audit my store free",
  },
  faq: {
  ...
  features: {
    ...
    feature3Up: "Skincare",
    feature3Down: "Supplements",
    forecastConservative: "Conservative",
    forecastBalanced: "Balanced",
    forecastAggressive: "Aggressive",
  },
  logoStrip: {
    caption:
  ...
  reviews: {
    ...
    pill1: "WHAT FOUNDERS SAY",
    pill2: "REAL, VERIFIED USERS",
    pillLanding: "What real users say",
    storeName: "Store name (optional)",
    storeNamePlaceholder: "Acme Goods",
    storeUrl: "Store URL (optional)",
    storeUrlPlaceholder: "acmegoods.com",
    consent: "Show my review publicly on the EliteVault site",
    bodyMin: "20–500 characters",
    editHeading: "Edit your review",
    update: "Update review",
    delete: "Delete",
    deleteConfirm: "Delete your review? This can't be undone.",
    deleted: "Your review was removed.",
    yourReviewStatus: "Your review",
    statusPending: "Pending approval",
    statusApproved: "Published",
    statusHidden: "Not shown",
    statusRejected: "Not approved",
    signInCta: "Sign in to leave a review",
    dashTitle: "Leave a review",
    dashBody: "Used EliteVault to audit your store? Tell other founders what it showed you.",
    dashCta: "Write a review",
    promptText: "How was your audit?",
    promptCta: "Leave a review",
    promptDismiss: "Dismiss",
    photosLabel: "Photos (optional)",
    photosHint: "Show your store or your results — up to {count}.",
    addPhoto: "Add photo",
...
const es: Dict = {
  ...
  footer: {
    ...
    convertmate: "Alternativa a ConvertMate",
    blog: "Blog",
    about: "Nosotros",
    support: "Soporte",
    api: "API",
  ...
  metaPromo: {
    ...
    teaserTitle: "Mira tu campaña de Meta antes de gastar un dólar",
    teaserBody:
      "Tres escenarios honestos de 7 días —conservador, equilibrado, agresivo— proyectados con tu tienda y tus números.",
    sampleLabel: "Ejemplo — no son tus números",
    roasLabel: "ROAS a 7 días",
    conservative: "Conservador",
    balanced: "Equilibrado",
    aggressive: "Agresivo",
    unlockPro: "Desbloquear con Pro — ${price}/mes",
    signupCta: "Crea tu cuenta gratis",
    runCta: "Correr tu simulación",
    optimizerUpsell: "El Optimizer de Meta Ads es del plan Scale.",
    optimizerCta: "Subir a Scale",
    railTitle: "Tu campaña de Meta, proyectada",
    mobileLocked: "Previsualiza tu campaña de Meta",
    mobileRun: "Tu simulador de Meta",
    cancelAnytime: "Cancela cuando quieras · prorrateado",
  },
  pricing: {
  ...
  compare: {
    ...
    closingBold: "audita tu tienda y te enseña a las ganadoras que copiar",
    closingPost: "— por el precio de un almuerzo.",
    cta: "Audita mi tienda gratis",
  },
  faq: {
  ...
  features: {
    ...
    feature3Up: "Skincare",
    feature3Down: "Suplementos",
    forecastConservative: "Conservador",
    forecastBalanced: "Equilibrado",
    forecastAggressive: "Agresivo",
  },
  logoStrip: {
    caption:
  ...
  reviews: {
    ...
    pill1: "LO QUE DICEN LOS FUNDADORES",
    pill2: "USUARIOS REALES Y VERIFICADOS",
    pillLanding: "Lo que dicen los usuarios reales",
    storeName: "Nombre de tu tienda (opcional)",
    storeNamePlaceholder: "Acme Goods",
    storeUrl: "URL de tu tienda (opcional)",
    storeUrlPlaceholder: "acmegoods.com",
    consent: "Mostrar mi reseña públicamente en el sitio de EliteVault",
    bodyMin: "20–500 caracteres",
    editHeading: "Edita tu reseña",
    update: "Actualizar reseña",
    delete: "Eliminar",
    deleteConfirm: "¿Eliminar tu reseña? No se puede deshacer.",
    deleted: "Tu reseña fue eliminada.",
    yourReviewStatus: "Tu reseña",
    statusPending: "Pendiente de aprobación",
    statusApproved: "Publicada",
    statusHidden: "No visible",
    statusRejected: "No aprobada",
    signInCta: "Inicia sesión para dejar una reseña",
    dashTitle: "Deja una reseña",
    dashBody: "¿Usaste EliteVault para auditar tu tienda? Cuéntale a otros fundadores qué te mostró.",
    dashCta: "Escribir reseña",
    promptText: "¿Qué tal tu auditoría?",
    promptCta: "Deja una reseña",
    promptDismiss: "Descartar",
    photosLabel: "Fotos (opcional)",
    photosHint: "Muestra tu tienda o tus resultados — hasta {count}.",
